...
def process_string (st):#Parses Landsat metadata
    return float(st.split(' = ')[1].strip('\n'))

def ndvi_calc(red, nir):
    return (nir - red) / (nir + red)

def emissivity_calc (pv, ndvi): #Calculates an estimate of emissivity
...
def array2tif(raster_file, new_raster_file, array):# Invoke the GDAL Geotiff driver
...
def lst_calc(location): #Calculate Estimate of Land Surface Temperature.
    ...
    meta_file = 'C:/Users/Yael nidam/Dropbox (MIT)/00_2018_Spring/03_Big_Data/BDVS_OpenSpace_Spring2018/August1/LC08_L1TP_012031_20170801_20170811_01_T1/'+ tifname +'MTL.txt'
...
DATA ='C:/Users/Yael nidam/Dropbox (MIT)/00_2018_Spring/03_Big_Data/BDVS_OpenSpace_Spring2018/August1/'
tifname='LC08_L1TP_012031_20170801_20170811_01_T1_'
...
out_path_ndvi = os.path.join(DATA, 'Nidam_ndvi_20170801.tif')
array2tif(tirs_path, out_path_ndvi, cloudfree_ndvi)

out_path_ndvi = os.path.join(DATA, 'lstno_clouds_20170801.tif')
array2tif(tirs_path, out_path_ndvi, lst)

out_path_lst = os.path.join(DATA, 'Nidam_lst_20170801.tif')
